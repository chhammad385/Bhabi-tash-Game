      ...
      <div className="flex items-center gap-1 sm:gap-2 md:gap-3">
        ...
        >
          ...
          {friendRequestCount > 0 && (
            <span
              aria-label={`${friendRequestCount} new friend request${friendRequestCount > 1 ? 's' : ''}`}
              className="absolute -top-1 -right-1 min-w-[16px] h-4 px-1 rounded-full bg-rose-500 text-white text-[10px] font-bold flex items-center justify-center shadow ring-2 ring-slate-900 animate-pulse"
            >
